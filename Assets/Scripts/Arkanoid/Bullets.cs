...
public class Bullets : MonoBehaviour
{
    ...
    private void OnCollisionEnter2D(Collision2D collision)
    {
        ...
        var direction = Vector2.Reflect(lastVeclocity.normalized, collision.contacts[0].normal);
        lastVeclocity = Vector3.Reflect(lastVeclocity, collision.contacts[0].normal);


        rb.velocity = direction * Mathf.Max(speed, shootSpeed);
        //rb.velocity = lastVeclocity;
        ...
        */
        ...
        if(col.CompareTag("Monster"))
        {
            ...
            //Debug.Log($"ㅁㄴㅅㅇㄹㄹ농 | {pointShoot.damage}");
        }
